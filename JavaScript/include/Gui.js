		...
		function createItem(value){
			var html =
				"<div class='GUITreeRow'>"+
					"<div class='GUITreeCell'><span class='GUITreeIcon'></div>"+
					"<div class='GUITreeCell'><div class='GUITreeBody'></div></div>"+
				"</div>"+
				"<div class='GUITreeRow'>"+
					"<div class='GUITreeCell'></div>"+
					"<div class='GUITreeCell'><div class='GUITreeChild'></div></div>"+
				"</div>";
